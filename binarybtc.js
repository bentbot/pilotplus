...
var schema = new mongoose.Schema({ user: 'string', preference: 'string', setting: Boolean });
...
function checknextTrade() {
  ...
  io.sockets.emit('nexttrade', { next: nexttrade, stoptrading: keys.site.stoptrading }); // Emit to chrome
